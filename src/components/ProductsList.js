        ...
        <div className="container mt-10">
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-md-10 col-lg-8">
              <form className="card card-sm p-1">
                <div className="card-body row align-items-center">
                  ...
                  <div className="col-auto">
                    <button className="inline-block rounded-md border border-transparent bg-gray-900 px-8 py-2 text-center font-medium text-white hover:bg-gray-700">
                      Search
                    </button>
                  </div>
                </div>
